...
namespace FXStudio
{
    class ToolStripExRenderer : ToolStripProfessionalRenderer
    {
        private static readonly CustomColorTable colorTable = new CustomColorTable();

        public ToolStripExRenderer() : base(colorTable)
        {

        }

        public new CustomColorTable ColorTable
        {
            ...
            if (e.Item.Enabled)
            {
                ...
                else if (e.Item.Selected)
                {
                    ...
                    var itemRect = isMenuDropDown ?
                        new Rectangle(contentRect.X + 2, contentRect.Y - 2,contentRect.Width - 5, contentRect.Height + 3) :
                        new Rectangle(contentRect.X, contentRect.Y - 1,contentRect.Width, contentRect.Height + 1);
