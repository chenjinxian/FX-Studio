...
public:
	...
	{
		return IEventDataPtr(DEBUG_NEW EvtData_New_Actor(m_ActorId, m_ViewId));
	}
...
public:
	...
	virtual IEventDataPtr VCopy() const
	{
		return IEventDataPtr(DEBUG_NEW EvtData_Destroy_Actor(m_ActorId));
	}
...
public:
	...
	virtual IEventDataPtr VCopy() const
	{
		return IEventDataPtr(DEBUG_NEW EvtData_New_Render_Component(m_ActorId, m_pSceneNode));
	}
...
public:
	...
	virtual IEventDataPtr VCopy() const
	{
		return IEventDataPtr(DEBUG_NEW EvtData_Modified_Render_Component(m_ActorId));
	}
...
public:
	...
	virtual IEventDataPtr VCopy() const
	{
		return IEventDataPtr(DEBUG_NEW EvtData_Environment_Loaded());
	}
...
public:
	...
	virtual IEventDataPtr VCopy() const
	{
		return IEventDataPtr(DEBUG_NEW EvtData_Remote_Environment_Loaded());
	}
...
public:
	...
	virtual IEventDataPtr VCopy() const
	{
		return IEventDataPtr(DEBUG_NEW EvtData_Request_Start_Game());
	}
...
public:
	...
	virtual IEventDataPtr VCopy() const
	{
		return IEventDataPtr(DEBUG_NEW EvtData_Remote_Client(m_SocketId, m_IpAddress));
	}
...
public:
	...
	virtual IEventDataPtr VCopy() const
	{
		return IEventDataPtr(DEBUG_NEW EvtData_Update_Tick(m_DeltaMilliseconds));
	}
...
public:
	...
	virtual IEventDataPtr VCopy() const
	{
		return IEventDataPtr(DEBUG_NEW EvtData_Network_Player_Actor_Assignment(m_ActorId, m_SocketId));
	}
...
public:
	...
	virtual IEventDataPtr VCopy() const
	{
		return IEventDataPtr(DEBUG_NEW EvtData_Decompress_Request(m_zipFileName, m_fileName));
	}
...
public:
	...
	virtual IEventDataPtr VCopy() const
	{
		return IEventDataPtr(DEBUG_NEW EvtData_Decompression_Progress(m_progress, m_zipFileName, m_fileName, m_buffer));
	}
...
public:
	...
	virtual IEventDataPtr VCopy() const
	{
		return IEventDataPtr(DEBUG_NEW EvtData_Request_New_Actor(
