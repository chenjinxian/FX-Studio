...
namespace CristiPotlog.WizardControl
{
    /// <summary>
    ...
    public class Wizard : System.Windows.Forms.UserControl
    {
        ...
        private readonly Point offsetNext = new Point(240, 36);
        private readonly Point offsetBack = new Point(316, 36);
        #endregion
        ...
        private void InitializeComponent()
        {
            ...
            this.buttonCancel.Location = new System.Drawing.Point(336, 242);
            ...
            this.buttonNext.Location = new System.Drawing.Point(184, 242);
            ...
            this.buttonBack.Location = new System.Drawing.Point(108, 242);
            ...
            this.buttonHelp.Location = new System.Drawing.Point(8, 242);
            ...
            this.buttonFinish.Location = new System.Drawing.Point(260, 242);
            ...
            this.Name = "Wizard";
            this.Size = new System.Drawing.Size(420, 274);
        ...
        public bool FinishEnabled
        {
            get
            {
                return this.buttonFinish.Enabled;
            }
            set
            {

                this.buttonFinish.Enabled = value;
            }
        }
        ...
        public string FinishText
        {
            get
            {
                return this.buttonFinish.Text;
            }
            set
            {

                this.buttonFinish.Text = value;
            }
        }
        ...
        protected override void OnResize(EventArgs e)
        {
            ...
            this.buttonCancel.Location = new Point(this.Width - this.offsetCancel.X, this.Height - this.offsetCancel.Y);
            this.buttonFinish.Location = new Point(this.Width - this.offsetFinish.X, this.Height - this.offsetFinish.Y);
            this.buttonNext.Location = new Point(this.Width - this.offsetNext.X, this.Height - this.offsetNext.Y);
            this.buttonBack.Location = new Point(this.Width - this.offsetBack.X, this.Height - this.offsetBack.Y);
            this.buttonHelp.Location = new Point(this.buttonHelp.Location.X, this.Height - this.offsetBack.Y);
        }
