...
namespace CristiPotlog.WizardControl
{
    ...
    public class WizardPage : Panel
    {
        ...
        private const int HEADER_GLYPH_SIZE = 40;
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            switch (this.style)
            {
                case WizardPageStyle.Standard:
                    ...
                    int headerPadding = (int)Math.Floor((HEADER_AREA_HEIGHT - HEADER_GLYPH_SIZE) / 2.0);
